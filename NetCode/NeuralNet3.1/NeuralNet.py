...
class NeuralNet(object):
    def __init__(self, hp, model_name):
        ...
        self.wb1 = WeightBias(self.hp.num_input, self.hp.num_hidden1, self.hp.init_method, self.hp.eta)
        self.wb1.InitializeWeights(self.subfolder, False)
        self.wb2 = WeightBias(self.hp.num_hidden1, self.hp.num_hidden2, self.hp.init_method, self.hp.eta)
        self.wb2.InitializeWeights(self.subfolder, False)
        self.wb3 = WeightBias(self.hp.num_hidden2, self.hp.num_output, self.hp.init_method, self.hp.eta)
